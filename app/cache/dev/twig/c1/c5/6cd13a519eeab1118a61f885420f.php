...
/* TcgDatabaseBundle:Classe:edit.html.twig */
class __TwigTemplate_c1c56cd13a519eeab1118a61f885420f extends Twig_Template
{
    protected $parent;
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 4
        echo "    <form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("classe_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "TcgDatabaseBundle:Classe:edit.html.twig";
    }
