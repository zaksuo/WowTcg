...
class __TwigTemplate_64fb712c722a37fe38b857d6fb065c74 extends Twig_Template
{
    protected $parent;
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 4
        echo "    <form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("type_carte_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "TcgDatabaseBundle:TypeCarte:edit.html.twig";
    }
